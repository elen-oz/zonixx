  ...
  return (
    <section>
      <div className="flex items-center justify-between">
        ...
        {workouts.length !== 0 && (
          <Button radius="none" onClick={clearAllWorkouts} className="uppercase" size="sm">
            Clear
          </Button>
        )}
      </div>
      {workouts.length !== 0 ? (
        ...
        <>
          ...
          <div className="w-full text-center">
            <Link href="/exercises" className=" uppercase text-2xl underline">
              Let&apos;s add some exercises!
            </Link>
          </div>
        </>
      )}
