...
import { Modal, useDisclosure, Card, CardHeader, CardFooter, Image } from '@nextui-org/react';
  ...
  return (
    ...
    >
      ...
      >
        ...
        {exercise.gifUrl ? (
          <img alt={exercise.name} className="h-full object-cover" src={exercise.gifUrl} />
        ) : (
          <Image
            src="/noimage.png"
